...
import persistencia.daoimpl.ParamedicoDAOEnH2;
...
public class Main {
    ...
    public static void probarDaoH2ConParamedicos() throws Exception {
        try (IParamedicoDAO dao = new ParamedicoDAOEnH2()) {
